...
public class FormService {
    static public func fetchFormConfiguration(apiEndpoint: String) async throws -> FormConfiguration {
    ...
    static public func submitFormData(apiEndpoint: String, formData: [UUID: String]) async throws {
        // Simulate network delay
        try await Task.sleep(nanoseconds: 2 * 1_000_000_000)
